...
#define SAVE_STATE_TRANSFER_BUFFER_ADDRESS      0x023E0000
#define SAVE_STATE_TRANSFER_BUFFER_SIZE         (64 * 1024)
#define SAVE_STATE_ARM9_ITCM_BUFFER0_ADDRESS    0x02FF0000
#define SAVE_STATE_ARM9_DTCM_BUFFER_ADDRESS     0x02FF4000
#define SAVE_STATE_ARM9_ITCM_BUFFER1_ADDRESS    0x02FF8000
#define SAVE_STATE_ARM9_ITCM_BUFFER_CHUNK_SIZE  (16 * 1024)
#define SAVE_STATE_ARM9_ITCM_BUFFER_SIZE        (32 * 1024)
#define SAVE_STATE_ARM9_DTCM_BUFFER_SIZE        (16 * 1024)
...
#define SAVE_STATE_ARM7_IO_STATE_ADDRESS        0x023FF1C0
#define SAVE_STATE_ARM9_DTCM_INFO_ADDRESS       0x02FFBFE8
#define SAVE_STATE_ARM9_ITCM_INFO_ADDRESS       0x02FFBFF0
#define SAVE_STATE_CONTEXT_MAGIC                0x43545831u
#define SAVE_STATE_DTCM_MAGIC                   0x4454434Du
#define SAVE_STATE_ITCM_MAGIC                   0x4954434Du
