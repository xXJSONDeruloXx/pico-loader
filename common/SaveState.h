...
#define SAVE_STATE_FILE_MAGIC_V9   0x38535350u // PSS8
#define SAVE_STATE_FILE_VERSION_V9 9u
...
struct save_state_arm9_itcm_state_t
{
    u32 magic;
    u32 size;
};

static_assert(sizeof(save_state_arm9_itcm_state_t) == 8);
...
struct save_state_file_header_v7_t
{
    u32 magic;
    u32 version;
    u32 arm9ContextOffset;
...
static_assert(sizeof(save_state_file_header_v7_t) == 88);

struct save_state_file_header_v9_t
{
    u32 magic;
    u32 version;
    u32 arm9ContextOffset;
...
static_assert(sizeof(save_state_file_header_v9_t) == 96);
